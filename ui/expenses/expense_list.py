...
class ExpenseDialog(QDialog):
    def __init__(self, parent=None, expense=None):
        ...
        self.category_combo.setToolTip("Type of expense (e.g. Electricity, Rent, Salaries)")
        ...
        self.amount_spin.setToolTip("Amount spent")
        self.desc_edit = QLineEdit()
        self.desc_edit.setToolTip("Brief description of what this expense was for")
        self.date_edit = QDateEdit(QDate.currentDate())
        self.date_edit.setCalendarPopup(True)
        self.date_edit.setToolTip("Date the expense was incurred")
        ...
        save_btn.setToolTip("Save this expense record")
...
class ExpenseListWidget(QWidget):
    def __init__(self):
        ...
        add_btn.setToolTip("Record a new business expense")
        add_btn.clicked.connect(self._add)
        header.addWidget(add_btn)
        layout.addLayout(header)

        subtitle = QLabel("Track daily business expenses by category")
        subtitle.setStyleSheet("color: #8b949e; font-size: 12px; padding: 0 0 12px 0;")
        layout.addWidget(subtitle)

        self.search_bar = QLineEdit()
        self.search_bar.setPlaceholderText("Search expenses...")
    ...
    def refresh(self):
        ...
        for i, e in enumerate(expenses):
            ...
            edit_btn.setToolTip("Edit this expense")
